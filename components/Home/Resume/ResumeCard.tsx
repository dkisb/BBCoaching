  ...
  return (
    <div className='mb-6'>
        ...
        <div className='flex-1'>
            {(company || duration) && (
                <h1 className='mb-2 sm:p-6 sm:py-1.5 px-4 py-1 rounded-full bg-gray-200 text-gray-600 w-fit sm:text-lg text-sm font-bold'>
                    {company}
                    {company && duration ? ' • ' : ''}
                    {duration}
                </h1>
            ...
            <p className='text-gray-200 text-sm sm:text-base pt-3'>
                {description}
            </p>
