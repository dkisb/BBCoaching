        ...
        <div className='w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10'>
            ...
            <div>
                <h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-200'>
                    Schedule a call with me <br /> <span className='text-[#0055ff]'>to get started</span>
                </h1>
                <p className='text-white mt-6 text-base sm:text-lg font-bold'>
                    I&#39;m always looking for new opportunities to work with drivers and teams. <span className='text-[#0055ff]'>If you have any questions or want to work with me, don&#39;t hesitate to contact me.</span>
                </p>
                <div className='mt-7'>
